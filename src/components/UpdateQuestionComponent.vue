<template>
    <div>
        <v-container>
                    ...
                    <v-container>
                        <v-layout>
                            <v-flex>
                                <v-card flat>
                                    <v-card-text>
                                        <h1 style="text-align:left">Update your Question</h1>
                                    </v-card-text>
                                </v-card>
                            </v-flex>
                        </v-layout>
                                ...
                                <v-card color="yellow lighten-4">
                                    <v-card-text>
                                        <v-card-text>
                                            ...
                                            <p>If your question is about this website, ask it on email <strong> forzaariefpyon@gmail.com .</strong>  </p>
                                        </v-card-text>
                                    </v-card-text>
                                </v-card>
                            </v-flex>
         ...
         <v-btn color="blue" class="buttonClass" @click="getIdToUpdate">Post Your Question</v-btn>
    </div>
</template>
...
export default {
    created () {
        this.getOneForQuestionUpdate(this.$route.params.id)
    },
    mounted () {
    },
    components : {
    ...
    methods: {
        ...mapActions([
            'updateQuestion', 'getOneForQuestionUpdate'
        ]),
        getIdToUpdate () {
